...
function Smartphone() {
  ...
  try {
    ...
    const res = await fetch(`${API_URL}/api/unified/smartphone-tablet`);
    const data = await res.json();
    console.log("Smartphone products:", data);
  ...
  return (
    <div className="container py-4">
      ...
      <h2 className="text-center mb-4">Smartphones & Tablets</h2>
      
      {products.length === 0 ? (
        <div className="text-center py-5">
          <p>No products found in Smartphone & Tablet category.</p>
        </div>
      ) : (
